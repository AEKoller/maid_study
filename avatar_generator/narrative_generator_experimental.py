...
# Retrieve the API key from environment variables in Replit
        ...
        message = client.messages.create(
            ...
            messages=[{
                ...
                "content": [{
                    ...
                    "Literacy: {patient_data['literacy']}
